...
export async function POST(request, { params }) {
    try {
        ...
        const alreadyReported = reply.reports.some(r => r.reporterId === userId);
        if (alreadyReported) {
            return NextResponse.json({ success: false, message: "You have already reported this comment" }, { status: 400 });
        }
