...
const GUIDELINES = [
  {
    ...
    description:
      "Treat everyone with respect. We're all here to learn. Use polite language and avoid personal attacks, name-calling, or harassment. Constructive criticism is welcome; mean-spirited comments are not.",
  ...
  },
  {
    ...
    description:
      "Do not post answers to live exams, share leaked materials, or help others cheat. Original work and honest discussion strengthen everyone's learning. Cite sources when you share content from elsewhere.",
  ...
  },
  {
    ...
    title: "Stay on topic",
    description:
      "Keep discussions relevant to the subject, chapter, or exam. Use the right thread or create a new one instead of derailing. This helps others find useful answers quickly.",
  ...
  },
  {
    ...
    description:
      "Do not post ads, referral links, or repeated promotional content. Occasional sharing of helpful resources may be allowed when relevant; commercial or off-topic promotion is not.",
  ...
  },
  {
    ...
    description:
      "No hate speech, discrimination, illegal content, or anything that threatens or demeans others. Do not share personal information of others without consent. Violations may lead to removal of content or access.",
  ...
  },
  {
    ...
    description:
      "Answer questions when you can, upvote helpful posts, and report content that breaks these guidelines. Your participation makes the hub better for everyone.",
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
          ...
          <div className="max-w-2xl">
            ...
            <p className="text-sm sm:text-base text-slate-600 leading-snug max-w-xl">
              By participating in our discussion hub, you agree to follow these
              guidelines. They help keep the community safe, helpful, and
              focused on learning.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            {GUIDELINES.map((item, i) => {
              ...
              return (
                <Card
                  ...
                  variant="standard"
                  hover={false}
                  className="p-5 sm:p-6 border-gray-200/60"
                >
                  <div className="flex gap-4">
                    <div
                      className={`shrink-0 w-12 h-12 rounded-xl flex items-center justify-center border ${item.color}`}
                    >
          ...
          <aside className="lg:col-span-4">
            <Card
              variant="standard"
              hover={false}
              className="p-5 border-gray-200/60 sticky top-24"
            >
              ...
              <ul className="space-y-3">
                {QUICK_TIPS.map((tip, i) => (
                  <li
                    key={i}
                    className="text-[13px] text-slate-600 leading-snug flex gap-2"
                  >
        ...
        <div className="mt-10 p-4 sm:p-5 bg-blue-50/50 rounded-xl border border-blue-100 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-[13px] text-blue-800/80 leading-relaxed">
              Every post is reviewed by our team. Content that violates these
              guidelines may be removed, and repeated violations can result in
              restricted access. We aim to keep the hub helpful and respectful
              for everyone.
            </p>
          </div>
        </div>
