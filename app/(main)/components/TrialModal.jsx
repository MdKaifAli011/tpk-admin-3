    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.data?.success) {
                ...
                setSubmitMessage("Success! Your trial session has been requested. We will contact you soon to schedule it.");
            ...
            setSubmitMessage(
                ...
                error?.message ||
                "Failed to book your trial session. Please try again."
            );
        } finally {
                            ...
                            <form onSubmit={handleSubmit} className="space-y-2.5">
                                ...
                                <div>
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className={`w-full pl-8 pr-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 transition-all text-sm ${errors.name ? "border-red-300 bg-red-50" : "border-gray-300 bg-white"}`}
                                ...
                                <div>
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            onChange={handleChange}
                                            className={`w-full pl-8 pr-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 transition-all text-sm ${errors.email ? "border-red-300 bg-red-50" : "border-gray-300 bg-white"}`}
                                ...
                                <div>
                                    <div className="relative">
                                        ...
                                        <select
                                            ...
                                            onChange={handleChange}
                                            className={`w-full pl-8 pr-3 py-2.5 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 transition-all appearance-none bg-white text-base ${errors.country ? "border-red-300 bg-red-50" : "border-gray-300"}`}
                                            disabled={isSubmitting}
                                        >
                                ...
                                <div>
                                    <div className="relative">
                                        ...
                                        <select
                                            ...
                                            onChange={handleChange}
                                            className={`w-full pl-8 pr-3 py-2.5 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 transition-all appearance-none bg-white text-base ${errors.className ? "border-red-300 bg-red-50" : "border-gray-300"}`}
                                            disabled={isSubmitting}
                                        >
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <div className="flex-1 relative">
                                            ...
                                            <input
                                                ...
                                                onChange={handleChange}
                                                className={`w-full pl-8 pr-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 transition-all text-sm ${errors.phoneNumber ? "border-red-300 bg-red-50" : "border-gray-300 bg-white"}`}
                                ...
                                <div>
                                    <div className="relative">
                                        ...
                                        <select
                                            ...
                                            onChange={handleChange}
                                            className={`w-full pl-8 pr-3 py-2.5 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 transition-all appearance-none bg-white text-base ${errors.subject ? "border-red-300 bg-red-50" : "border-gray-300"}`}
                                            disabled={isSubmitting}
                                        >
                                            <option value="">-- Preferred Exam --</option>
                                        ...
                                        <div className="flex-1 flex items-center gap-2">
                                            ...
                                            <div className="w-20">
                                                <input
                                                    ...
                                                    placeholder="Ans"
                                                    className={`w-full px-2 py-1.5 border-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 transition-all text-center font-semibold text-sm ${errors.verification ? "border-red-300 bg-red-50" : isVerified ? "border-green-500 bg-green-50" : "border-gray-300 bg-white"}`}
                                                    autoComplete="off"
                                                    disabled={isSubmitting}
                                                />
                                            </div>
                                            <button
                                                ...
                                                disabled={isSubmitting}
                                                className="shrink-0 p-1.5 text-gray-500 hover:text-green-600 hover:bg-green-50 rounded-lg transition-colors"
                                            >
                                ...
                                <div className="pt-1 flex gap-2">
                                    ...
                                    <button
                                        type="submit"
                                        disabled={isSubmitting}
                                        className="flex-1 px-3 py-2 bg-green-600 hover:bg-green-700 text-white font-semibold rounded-lg text-sm transition-colors flex items-center justify-center gap-2"
                                    >
                                        {isSubmitting ? (
                                            <>
