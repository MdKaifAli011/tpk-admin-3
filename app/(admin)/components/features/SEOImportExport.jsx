                        ...
                        <div className="overflow-auto scrollbar-thin">
                            <table className="w-full text-left text-sm border-collapse">
                                <thead className="bg-gray-50 border-b-2 border-gray-200 sticky top-0 z-10">
                                    <tr>
                                        <th className="px-4 py-3 font-semibold text-gray-700 whitespace-nowrap border-r border-gray-200">Name</th>
                                        <th className="px-4 py-3 font-semibold text-gray-700 whitespace-nowrap border-r border-gray-200">SEO Title</th>
                                        <th className="px-4 py-3 font-semibold text-gray-700 whitespace-nowrap border-r border-gray-200">Description</th>
                                        <th className="px-4 py-3 font-semibold text-gray-700 whitespace-nowrap border-r border-gray-200">Keywords</th>
                                        <th className="px-4 py-3 font-semibold text-gray-700 whitespace-nowrap text-center">Status</th>
                                    </tr>
                                </thead>
                                <tbody className="divide-y divide-gray-100">
                                        ...
                                        <tr key={idx} className="hover:bg-blue-50/30 transition-colors">
                                            ...
                                            <td className="px-4 py-3 text-gray-700 border-r border-gray-100 align-top">
                                                <div className="min-w-[200px] max-w-[400px]">
                                                    {row["SEO Title"] || row.seotitle || row.title || row.Title || "-"}
                                                </div>
                                            </td>
                                            <td className="px-4 py-3 text-gray-600 border-r border-gray-100 align-top">
                                                <div className="min-w-[250px] max-w-[500px] text-xs leading-relaxed">
                                                    {row.Description || row.description || row["Meta Description"] || row.metadescription || "-"}
                                                </div>
                                            </td>
                                            <td className="px-4 py-3 text-gray-600 border-r border-gray-100 align-top">
                                                <div className="min-w-[150px] max-w-[300px] text-xs">
                                                    {row.Keywords || row.keywords || "-"}
                                                </div>
                                            </td>
                                            <td className="px-4 py-3 text-center align-top">
                                                <div className="flex justify-center">
                                                    <span className={`px-3 py-1 rounded-full text-[10px] uppercase font-bold whitespace-nowrap inline-block ${(row.Status || row.status)?.toLowerCase() === 'publish'
                                                        ? 'bg-green-100 text-green-700 border border-green-200'
                                                        : (row.Status || row.status)?.toLowerCase() === 'unpublish'
                                    ...
                                    {parsedData.length > 50 && (
                                        <tr>
                                            <td colSpan="5" className="px-4 py-4 text-center text-gray-400 italic bg-gray-50/50 border-t-2 border-gray-200">
                                                <div className="flex items-center justify-center gap-2">
                                                    <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                                        <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
                                                    </svg>
                                                    <span>Showing first 50 of {parsedData.length} rows. Click "Start Import" to process all data.</span>
                                                </div>
                                            </td>
                                        </tr>
                                    )}
