        ...
        <>
            ...
            <div className="space-y-6 max-w-5xl mx-auto">
                ...
                <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-xl p-6 text-white shadow-lg">
                    <h1 className="text-2xl font-bold mb-2">Bulk Import Management</h1>
                    <p className="opacity-90">
                        Import bulk data for Exams, Subjects, Units, Chapters, Topics, and more.
                    </p>
                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        {importMode === "context-locked" && (
                            <div className="md:col-span-2 bg-blue-50 border border-blue-200 rounded-lg p-4">
                                <h3 className="font-semibold text-blue-900 mb-2">🔒 Context-Locked Import Mode</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
                        <div className="flex justify-between items-center mb-4">
                            <h2 className="text-lg font-semibold text-gray-800">2. Upload Data</h2>
                            <button
                        ...
                        <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:bg-gray-50 transition-colors relative">
                            ...
                            {file ? (
                                ...
                                <div>
                                    <p className="text-gray-700 font-medium">Click or Drag CSV file here</p>
                    ...
                    <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 flex flex-col justify-between">
                        <div>
                            <h2 className="text-lg font-semibold text-gray-800 mb-4">3. Summary</h2>
                            <div className="space-y-3">
                                ...
                                {importStatus === 'success' && (
                                    <div className="bg-green-50 p-3 rounded-lg border border-green-200 text-green-800 text-sm">
                                        <div className="flex items-center gap-2 font-bold mb-1"><FaCheckCircle /> Import Complete</div>
                                        <p>Successfully imported {results.success} items.</p>
                                        {results.failed > 0 && <p className="text-red-600 mt-1">Failed: {results.failed}</p>}
                                    </div>
                                )}
                                {importStatus === 'error' && (
                                    <div className="bg-red-50 p-3 rounded-lg border border-red-200 text-red-800 text-sm max-h-40 overflow-y-auto">
                                        <div className="flex items-center gap-2 font-bold mb-1"><FaExclamationCircle /> Import Errors</div>
                        ...
                        <button
                            ...
                            className={`w-full mt-6 py-3 px-4 rounded-lg font-bold text-white shadow-md transition-all flex justify-center items-center gap-2
                            ...
                            <table className="w-full text-left text-sm">
                                <thead className="bg-gray-100 text-gray-600 border-b border-gray-200">
                                    <tr>
                                        ...
                                        {headers.map(h => <th key={h} className="px-4 py-3 capitalize">{h}</th>)}
                                    </tr>
                                </thead>
