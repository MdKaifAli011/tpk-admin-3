...
const DefinitionsTable = ({
  ...
  // Fetch visit statistics for all definitions
  const { statsMap, loading: statsLoading } = useMultipleVisitStats(definitions, 'definition');
                          ...
                          {statsLoading ? (
                            ...
                            <div className="flex flex-col">
                              <span className="text-sm font-medium text-gray-900">
                                {statsMap[definition._id]?.totalVisits || 0}
                              </span>
                              <span className="text-xs text-gray-500">
                                ({statsMap[definition._id]?.uniqueVisits || 0} unique)
                              </span>
                            </div>
                          )}
                        </td>
                        <td className="px-2 py-1 whitespace-nowrap text-center">
                          {statsLoading ? (
                            ...
                            <span className="text-sm text-gray-900">
                              {statsMap[definition._id]?.todayVisits || 0}
                            </span>
                          )}
                        </td>
